...
const TechnicalProficiency = () => {
  ...
  return (
    <section id='skills' className='bg-[#fffcf8] mt-20'>
      <div className="container mx-auto p-10">
        <div className="w-full lg:w-[60vw] mx-auto ">
          ...
          <p className='text-sm text-center mt-4 leading-6'>
            ...
            tools, and frameworks, dedicated to buliding efficient and scalable 
            user-centric solutions.
          </p>
        </div>

        <Tabs tabList={SKILL_TABS}
          activeTab={activeTab}
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 min-h-[430px]'>
          {tabData.map((skill, index) => (
            <motion.div key={skill.id} initial={{opacity:0, y:20}} animate={{opacity: 1,y:0}} transition={{duration:0.4, delay: index * 0.1}}>
              <SkillCard
